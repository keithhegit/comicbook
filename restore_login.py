...
# 1. Add authentication state and logic
auth_code = '''  // 认证状态
...
if "Logout ({currentUser})" not in content:
    content = content.replace(old_header, new_header)

# 4. Add LoginPage component
login_component = '''
// --- 登录组件 ---
...
if "const LoginPage" not in content:
    content = content.replace('export default App;', f'{login_component}\nexport default App;')
